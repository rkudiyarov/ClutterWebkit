...
struct _WebKitWebViewClass {
    ...
    gboolean                   (*can_take_focus)          (WebKitWebView* web_view);
    void                       (*get_page_rect)           (WebKitWebView* web_view, 
                                                           int* x, 
                                                           int* y, 
                                                           int* width, 
                                                           int* height);
    void                       (*request_focus)           (WebKitWebView* web_view);
    void                       (*lose_focus)              (WebKitWebView* web_view);
...
WEBKIT_API ClutterActor *
webkit_web_view_new (guint width, guint height);
