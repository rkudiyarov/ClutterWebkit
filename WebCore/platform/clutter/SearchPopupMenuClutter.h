...
#ifndef SearchPopupMenuClutter_h
#define SearchPopupMenuClutter_h
...
class SearchPopupMenuClutter : public SearchPopupMenu {
public:
    SearchPopupMenuClutter(PopupMenuClient*);
...
private:
    RefPtr<PopupMenuClutter> m_popup;
};

}

#endif // SearchPopupMenuClutter_h
